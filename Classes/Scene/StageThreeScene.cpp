...
bool StageThreeScene::init() {
	...
	// TODO 백그라운드를 설정한다.
	background = Cocos2dFacade::CreateSprite("game_background_three.png");
...
void StageThreeScene::menuCloseCallback(CCObject* pSender) {
...
void StageThreeScene::ccTouchesEnded(CCSet *pTouch, CCEvent *pEvent) {
	//터치를하면 불러온다.
